...
foregroundOriginal = cv2.imread('C:\\xampp\\htdocs\\BodyPos\\MediaPipe\\HandPos\\Eletromidia_logo.png')
...
with mp_hands.Hands(min_detection_confidence=0.8, min_tracking_confidence=0.4) as hands:
    ...
    while cap.isOpened():
        ...
        cv2.putText(image,'INTERAGIR COM LOGO - ARRASTAR',(465,90) , cv2.FONT_HERSHEY_PLAIN,2,(0,255,255),2,cv2.LINE_AA)
